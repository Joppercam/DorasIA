...
class ImportJapaneseDramas extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import:japanese-dramas {--pages=5} {--update} {--force}';
     ...
     * @var string
     */
    protected $description = 'Import Japanese dramas from TMDB API';
    ...
    public function handle()
    {
        ...
        $this->info("Importing Japanese dramas (pages: {$pages}, update: " . ($update ? 'yes' : 'no') . ")");

        // Ensure J-Drama category exists
        $category = Category::firstOrCreate(
            ['slug' => 'j-drama'],
            [
                'name' => 'J-Drama',
                'description' => 'Series de televisión japonesas',
                'language' => 'ja',
                'country' => 'Japón',
            ]
        );
