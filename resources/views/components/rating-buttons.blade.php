...
<div class="card-rating-buttons">
    ...
    @php
        ...
        // Use the fixed counts from database columns instead of counting relations
        $ratingCounts = [
            'like' => $series->like_count ?? 0,
            'love' => $series->love_count ?? 0,
            'dislike' => $series->getRatingCounts()['dislike'] ?? 0 // Keep dislike as relation count
        ];
