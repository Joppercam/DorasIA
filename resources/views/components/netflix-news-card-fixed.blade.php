...
<div class="netflix-card news-card-container group">
    <a href="{{ route('news.show', $news->slug) }}" class="block h-full">
        <div class="h-full flex flex-col">
            <!-- Featured image banner - altura fija -->
            <div class="relative h-56 bg-gradient-to-t from-gray-900 to-gray-800 flex-shrink-0">
            ...
            <!-- Content section - flex para ocupar el resto del espacio -->
            <div class="flex-1 p-6 flex flex-col">
                ...
                <div class="flex-1 overflow-hidden">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-gray-200 text-sm mt-1 line-clamp-1">
                            @foreach($news->people->take(2) as $index => $person)
                                {{ $person->name }}@if(!$loop->last), @endif
                            @endforeach
                            @if($news->people->count() > 2)
                                <span class="text-gray-400">+{{ $news->people->count() - 2 }}</span>
                            @endif
                        </p>
                    </div>
                    @endif
                ...
                <div class="pt-3 border-t border-gray-800 flex-shrink-0">
