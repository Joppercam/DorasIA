...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-8">Debug Title Components</h1>
    ...
    @if($title)
        <div class="mb-8 bg-gray-800 p-6 rounded">
            <h2 class="text-xl font-bold mb-4">Title Info</h2>
            <p>ID: {{ $title->id }}</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
                <h2 class="text-xl font-bold mb-4">Debug Comments Component</h2>
                <x-debug-comments :title="$title" />
            </div>
